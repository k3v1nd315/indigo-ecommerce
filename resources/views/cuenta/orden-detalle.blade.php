            ...
            <div class="card-body">
                ...
                <div class="row mt-5"><!-- BEGIN ORDER MSG -->
                    ...
                    <div id="success_form" class="col-12 col-sm-12 mx-auto text-center" style="display:none;">
                      ...
                      <h5 class="h6" id="success_form_response">Se ha realizado la orden satisfactoriamente, le hemos enviado un mensaje a su correo, con la información detallada de la orden. Si no logras visualizar el mensaje, asegúrate revisar tu carpeta SPAM</h5>
                      <br>
                    </div>
